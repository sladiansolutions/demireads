 ...
 * first is also the Family Book word and the one spoken on a tap. The first
 * words are the ones Sebastian himself uses, which is why some are not the
 * obvious phonics choice: his D is a door, his I is an iron, his T is a toy.
 * A parent can override any of them in the parent area.
 *
...
export const LETTERS: readonly LetterContent[] = [
  ...
  { letter: 'D', soundLabel: '/d/', soundSpoken: 'duh', words: ['door', 'dog'] },
  ...
  { letter: 'I', soundLabel: '/i/', soundSpoken: 'ih', words: ['iron', 'igloo'] },
  { letter: 'J', soundLabel: '/j/', soundSpoken: 'juh', words: ['jar', 'jam'] },
  { letter: 'K', soundLabel: '/k/', soundSpoken: 'kuh', words: ['kite', 'key'] },
  { letter: 'L', soundLabel: '/l/', soundSpoken: 'lll', words: ['lion', 'leaf'] },
  { letter: 'M', soundLabel: '/m/', soundSpoken: 'mmm', words: ['monkey', 'moon'] },
  ...
  { letter: 'R', soundLabel: '/r/', soundSpoken: 'rrr', words: ['rose', 'rabbit'] },
  { letter: 'S', soundLabel: '/s/', soundSpoken: 'sss', words: ['sun', 'star'] },
  { letter: 'T', soundLabel: '/t/', soundSpoken: 'tuh', words: ['toy', 'tiger'] },
